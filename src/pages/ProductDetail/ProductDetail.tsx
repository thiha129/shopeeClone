...
export default function ProductDetail() {
  ...
  const handleZoom = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    // Cách 1 : Lấy offsetX, offsetY đơn giản khi chúng ta đã xử lý được bubble event + (Thêm class pointer-events-none)
    const { offsetX, offsetY } = event.nativeEvent

    // Cách 2: Lấy offsetX, offsetY đơn giản khi chúng ta không xử lý được bubble event + (Loại bổ class pointer-events-none)
              ...
              <div>
                ...
                <div className='mt-8 flex items-center'>
                  ...
                  <div className='ml-10 flex items-center '>
                    <button className='button flex h-8 w-8 items-center justify-center rounded-l-sm border border-gray-300 text-gray-600'>
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        fill='none'
                        viewBox='0 0 24 24'
                    ...
                    />
                    <button className='button flex h-8 w-8 items-center justify-center rounded-r-sm border border-gray-300 text-gray-600'>
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        fill='none'
                        viewBox='0 0 24 24'
